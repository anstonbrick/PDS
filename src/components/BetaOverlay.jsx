    ...
    return (
        <div className="fixed bottom-6 right-6 z-[9999]">
                ...
                {isOpen && (
                    ...
                    >
                        <div className="p-4 border-b border-zinc-800 flex justify-between items-center bg-zinc-950">
                            <h3 className="font-bold text-sm text-electric-blue">Beta Feedback</h3>
                        ...
                        {sent ? (
                            <div className="p-8 text-center">
                                <div className="text-green-500 mb-2">Build The Future.</div>
                                <div className="text-xs text-zinc-500">Thanks for your input.</div>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} className="p-4">
                                ...
                                >
                                    {sending ? 'Transmitting...' : <><Send size={14} /> Send Feedback</>}
                                </button>
                            </form>
                        )}
                    </motion.div>
            ...
            >
                ...
                <span className="font-bold text-sm pr-1">Beta Feedback</span>
            </motion.button>
        </div>
    );
};
